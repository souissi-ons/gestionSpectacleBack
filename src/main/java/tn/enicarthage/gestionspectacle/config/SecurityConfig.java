package tn.enicarthage.gestionspectacle.config;
...
import tn.enicarthage.gestionspectacle.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(
                                "/api/auth/**",
                                "/api/reservations/anonymous/**",
                                "/api/reservations",
                                "/api/**",
                                "/api/spectacles/date-lieu/**/places"
                        ).permitAll()
